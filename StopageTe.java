...
public class StopageTe extends JFrame {
private JFrame back;

public StopageTe(JFrame routinePage) {
...
ImageIcon logo = new ImageIcon("img/TE-C.jpg");
        ...
        JButton backbtn = new JButton("Back");
	     ...
	     JLabel note = new JLabel(
					"<html><div style = 'text-align: center;'> Bus Starts From Temukhi at: 8:05 AM and 11:00 AM<br> "
...
public StopageTe(routinePage routinePage) {
