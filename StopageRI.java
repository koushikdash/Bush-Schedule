...
public class StopageRI extends JFrame {
  private JFrame back;

public StopageRI(JFrame routinePage) {
  ...
  ImageIcon logo = new ImageIcon("img/R-C.jpg");
	        ...
	        JButton backbtn = new JButton("Back");
		     ...
		     JLabel note = new JLabel(
						"<html><div style = 'text-align: center;'> Bus Starts From RikabiBazar at: 8:15 AM and 11:00 AM<br> "
...
public StopageRI(routinePage routinePage) {
