...
public class StopageKazi extends JFrame {
	private JFrame back;

	public StopageKazi(JFrame routinePage){
    ...
    ImageIcon logo = new ImageIcon("img/kA-C.jpg");
	        ...
	        JButton backbtn = new JButton("Back");
		     ...
		     JLabel note = new JLabel(
						"<html><div style = 'text-align: center;'> Bus Starts From Kazir-Bazar at: 8:10 AM and 11:00 AM<br> "
	...
	public StopageKazi(routinePage routinePage) {
